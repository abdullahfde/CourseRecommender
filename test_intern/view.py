...
def get_data(request):
    ...
    return render_to_response('Home.html', {'form': form, 'formForChoice': formForChoice,'SettingsForms1':SettingsForms1,'wait':
        wait},
...
def UserSaved(request):
    ...
    return render_to_response('Results.html', {'FinalData': FinalData, 'newMan':newMan, 'newDepartmentElective':newDepartmentElective,
